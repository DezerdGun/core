...
$this->params['breadcrumbs'][] = ['label' => Yii::t('models.plural', 'Container'), 'url' => ['index']];
...
<div class="giiant-crud container-view">
 ...
 echo Html::a(
            ...
            ['create', 'code' => $model->code, 'Container'=>$copyParams],
 ...
 echo Html::a(
    ...
    <?php $this->beginBlock('common\models\Container'); ?>
 ...
 [
    ...
    'content' => $this->blocks['common\models\Container'],
    'active'  => true,
],
 ]
                 ]
