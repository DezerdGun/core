...
/**
 * This is the base-model class for table "ordinary_holds_history".
 *
 * @property integer $id
 ...
 */
abstract class OrdinaryHoldsHistory extends \yii\db\ActiveRecord
{
