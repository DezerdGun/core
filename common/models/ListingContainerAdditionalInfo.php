...
use Yii;
use \common\models\base\ListingContainerAdditionalInfo as BaseListingContainerAdditionalInfo;
use yii\helpers\ArrayHelper;

/**
 * This is the model class for table "listing_container_additional_info".
 */
class ListingContainerAdditionalInfo extends BaseListingContainerAdditionalInfo
{
    public $hazmat;
    public $overweight;
    public $reefer;
